...
/* harmony export (immutable) */ __webpack_exports__["a"] = visualization;
/**
...
function visualization(geoJson, opts) {
    ...
    let projection = __WEBPACK_IMPORTED_MODULE_0_d3__["geoMercator"]()
                       .scale(opts.scale)
                       .center([16, 57])
    ...
    function drawMap() {
        svgElement.selectAll("path")
                  ...
                  .enter()
                  .append("path")
                  .attr("d", __WEBPACK_IMPORTED_MODULE_0_d3__["geoPath"](projection))
    ...
    function highlightSelectedCountry(country) {
        ...
        // Fill the country
        __WEBPACK_IMPORTED_MODULE_0_d3__["select"](country)
          .classed("selectedCountry", true);
    }

    function showInfoBox(country) {
        let selectedCountryName = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](country).attr("id");
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["select"]("#infoBox")
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__visualization__ = __webpack_require__(3);
...
let svg = __WEBPACK_IMPORTED_MODULE_2_d3__["select"]("body")
...
__WEBPACK_IMPORTED_MODULE_2_d3__["json"]("./src/js/europe.json", (json) => {
    let geojson = __WEBPACK_IMPORTED_MODULE_1_topojson__["feature"](json, json.objects.europe);
    __WEBPACK_IMPORTED_MODULE_2_d3__["csv"]("./src/csv/europe.csv", (data) => {
        let mapVisualization = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__visualization__["a" /* visualization */])(geojson, opts);
